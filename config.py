...
# Конфигурация подписок на опционы для ручного входа в позицию
SUBSCRIPTION_CONFIG = {
    ...
    "price_drift_steps_trigger": 5,        # Переподписка, если цена спота ушла на столько шагов от цены при последней подписке
}
